...
const FarmCards: React.FC = () => {
  ...
  const steakIndex = farms.findIndex(
    ({ tokenSymbol }) => tokenSymbol === 'STEAK',
  )

  const steakPrice =
    steakIndex >= 0 && stakedValue[steakIndex]
      ? stakedValue[steakIndex].tokenPriceInWeth
      : new BigNumber(0)

  const BLOCKS_PER_YEAR = new BigNumber(2336000)
  const STEAK_PER_BLOCK = new BigNumber(250)
        ...
        <CardContent>
          <StyledContent>
            ...
            <StyledInsight>
              ...
              <span>
                {(farm.wethAmount && farm.wethAmount > new BigNumber(0))
                  ? (farm.wethAmount.toNumber() || 0).toLocaleString('en-US') + ' ETH'
                  : (farm.tokenAmount ? farm.tokenAmount.toNumber() : 0).toLocaleString('en-US') + ' ' + farm.tokenSymbol}{' '}
              </span>
            </StyledInsight>
          </StyledContent>
        </CardContent>
